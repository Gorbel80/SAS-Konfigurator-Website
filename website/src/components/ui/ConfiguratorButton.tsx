...
const sizes: Record<Size, { btn: string; icon: string; badge: string }> = {
  ...
  header: {
    btn: "h-8 gap-1.5 rounded-full px-3 pl-2.5 text-xs",
    icon: "h-3.5 w-3.5",
...
/**
 * Opens the in-app 3D configurator at /{locale}/konfigurator.
 * Works on Vercel and static All-Inkl export (same HTML routes).
 */
